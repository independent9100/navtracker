...
/**
 * One region label parsed from the label CSV: a class, a rough position
 * (lat/lon + radius), and an active time window relative to the clip start.
 * Consumed by the label-aware philos decomposition, not by GOSPA truth.
 */
