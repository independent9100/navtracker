...
PrescribedTurn::PrescribedTurn(double prescribed_omega,
                               double accel_psd,
                               double omega_psd)
    : omega_(prescribed_omega), q_a_(accel_psd), q_omega_(omega_psd) {}

Eigen::MatrixXd PrescribedTurn::transitionMatrix(double dt) const {
...
Eigen::MatrixXd PrescribedTurn::processNoise(double dt) const {
