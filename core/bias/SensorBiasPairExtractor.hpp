...
/**
 * Tuning for the pair-extraction free functions below: the per-cycle
 * contribution window and the fallback 1-σ position uncertainties used when a
 * measurement's own covariance is degenerate.
 */
